package com.woime.iboss.core;

import com.woime.iboss.core.util.Md5Utils;

/**
 * 对传入的URL附加key，计算md5，得到一个32位的字符串。 MD5的值确实是16进制的，所以它可以表示16 ^ 32 =
 * 3.4028236692093846346337460743177e+38种组合
 * 把md5分成四段，每段是16 ^ 8 = 4 294 967 296，40多亿，认为这种的碰撞几率也是很小的
 * 然后用a-zA-Z0-9表示6位的62进制，62 ^ 6 = 56 800 235
