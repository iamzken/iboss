package com.woime.iboss.meeting.web;
...
import com.woime.iboss.meeting.persistence.manager.MeetingAttendeeManager;
import com.woime.iboss.meeting.persistence.manager.MeetingInfoManager;
import com.woime.iboss.meeting.persistence.manager.MeetingItemManager;
import com.woime.iboss.meeting.persistence.manager.MeetingRoomManager;
...
public class MeetingInfoController
{
	...
	public String save(@ModelAttribute MeetingInfo meetingInfo, @RequestParam("meetingRoomId") Long meetingRoomId, @RequestParam("attendees") String attendees,
			@RequestParam(value = "items", required = false) List<String> items, RedirectAttributes redirectAttributes)
	{
		String tenantId = tenantHolder.getTenantId();
