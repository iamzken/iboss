package com.woime.iboss.vote.web;
...
import com.woime.iboss.vote.persistence.manager.VoteInfoManager;
...
public class VoteInfoController
{
	...
	public String save(@ModelAttribute VoteInfo voteInfo, @RequestParam Map<String, Object> parameterMap, RedirectAttributes redirectAttributes)
	{
		String tenantId = tenantHolder.getTenantId();
		VoteInfo dest = null;
