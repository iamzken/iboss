package com.woime.iboss.workcal.support;
...
public class WorkDay
{
	...
	public boolean isSameDay(Date workDate)
	{
		...
		return (workCalendar.get(Calendar.YEAR) == targetCalendar.get(Calendar.YEAR)) && (workCalendar.get(Calendar.MONTH) == targetCalendar.get(Calendar.MONTH))
