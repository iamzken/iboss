...
//	private TenantHolder tenantHolder;
	...
	@Produces(MediaType.APPLICATION_JSON)
	public BaseDTO processInstancesRunning(@HeaderParam("sessionId") String sessionId) throws Exception
	{
		logger.info("start");
	...
	@Produces(MediaType.APPLICATION_JSON)
	public BaseDTO processInstancesComplete(@HeaderParam("sessionId") String sessionId) throws Exception
	{
		logger.info("start");
		...
		String userId = pimDevice.getUserId();
		String tenantId = "1";
		List<HistoricProcessInstance> historicProcessInstances = processEngine.getHistoryService().createHistoricProcessInstanceQuery().processInstanceTenantId(tenantId).startedBy(userId).finished()
				.list();
	...
	@Produces(MediaType.APPLICATION_JSON)
	public BaseDTO processInstancesDraft(@HeaderParam("sessionId") String sessionId) throws Exception
	{
		logger.info("start");
