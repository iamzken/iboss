...
//	private TenantHolder tenantHolder;
	...
	@Path("tasksPersonal")
	@Produces(MediaType.APPLICATION_JSON)
	public BaseDTO tasksPersonal(@HeaderParam("sessionId") String sessionId) throws Exception
	{
		logger.info("start");
	...
	@Path("tasksGroup")
	@Produces(MediaType.APPLICATION_JSON)
	public BaseDTO tasksGroup(@HeaderParam("sessionId") String sessionId) throws Exception
	{
		logger.info("start");
	...
	@Path("tasksComplete")
	@Produces(MediaType.APPLICATION_JSON)
	public BaseDTO tasksComplete(@HeaderParam("sessionId") String sessionId) throws Exception
	{
		logger.info("start");
		...
		String userId = pimDevice.getUserId();
		String tenantId = "1";
		Page page = humanTaskConnector.findFinishedTasks(userId, tenantId, 1, 10);
		List<HumanTaskDTO> humanTaskDtos = (List<HumanTaskDTO>) page.getResult();
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
	...
	@Path("tasksDelegate")
	@Produces(MediaType.APPLICATION_JSON)
	public BaseDTO tasksDelegate(@HeaderParam("sessionId") String sessionId) throws Exception
	{
		logger.info("start");
		...
		String userId = pimDevice.getUserId();
		String tenantId = "1";
		Page page = humanTaskConnector.findDelegateTasks(userId, tenantId, 1, 10);
		List<HumanTaskDTO> humanTaskDtos = (List<HumanTaskDTO>) page.getResult();
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
