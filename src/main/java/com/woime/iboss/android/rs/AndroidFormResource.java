...
import com.woime.iboss.model.support.FormField;
...
//	private PimDeviceManager pimDeviceManager;
	...
	public String viewStartForm(@FormParam("processDefinitionId") String processDefinitionId) throws Exception
	{
		...
		buff.append("<xmlgui>").append("<form id='1' name='form' submitTo='http://192.168.1.106:8080/devaeye-app-lemon/rs/android/bpm/startProcess' >");
		...
		for (FormField formField : formFields)
		{
			...
			if ("radio".equals(formField.getType()) || "checkbox".equals(formField.getType()) || "select".equals(formField.getType()))
			{
				type = "choice";
	...
	public String viewTaskForm(@FormParam("taskId") String taskId) throws Exception
	{
		...
		buff.append("<xmlgui>").append("<form id='1' name='form' submitTo='http://192.168.1.106:8080/devaeye-app-lemon/rs/android/task/completeTask'").append(" readOnly='")
				.append("complete".equals(humanTaskDto.getStatus())).append("'").append(" >");
