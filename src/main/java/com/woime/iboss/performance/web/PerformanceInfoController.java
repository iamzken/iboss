package com.woime.iboss.performance.web;
...
import com.woime.iboss.performance.persistence.manager.PerformanceInfoManager;
...
public class PerformanceInfoController
{
	...
	public String save(@ModelAttribute PerformanceInfo performanceInfo, @RequestParam Map<String, Object> parameterMap, RedirectAttributes redirectAttributes)
	{
		String tenantId = tenantHolder.getTenantId();
	...
	{
		List<PerformanceInfo> performanceInfos = performanceInfoManager.findByIds(selectedItem);
	...
	public void export(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		List<PerformanceInfo> performanceInfos = (List<PerformanceInfo>) page.getResult();
	...
	// ~ ======================================================================
	@Resource
	public void setPerformanceInfoManager(PerformanceInfoManager performanceInfoManager)
	{
