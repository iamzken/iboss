package com.woime.iboss.employee.web;
...
import com.woime.iboss.employee.persistence.manager.EmployeeInfoManager;
...
public class EmployeeInfoController
{
	...
	public String save(@ModelAttribute EmployeeInfo employeeInfo, @RequestParam Map<String, Object> parameterMap, RedirectAttributes redirectAttributes)
	{
		String tenantId = tenantHolder.getTenantId();
	...
	{
		List<EmployeeInfo> employeeInfos = employeeInfoManager.findByIds(selectedItem);
	...
	public void export(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		List<EmployeeInfo> employeeInfos = (List<EmployeeInfo>) page.getResult();
