...
import com.woime.iboss.humantask.rule.ActivityAssigneeRule;
import com.woime.iboss.humantask.rule.AssigneeRule;
import com.woime.iboss.humantask.rule.EqualsRuleMatcher;
import com.woime.iboss.humantask.rule.InitiatorAssigneeRule;
import com.woime.iboss.humantask.rule.PositionAssigneeRule;
import com.woime.iboss.humantask.rule.PrefixRuleMatcher;
import com.woime.iboss.humantask.rule.RuleMatcher;
import com.woime.iboss.humantask.rule.SuperiorAssigneeRule;
...
public class AssigneeAliasHumanTaskListener implements HumanTaskListener
{
	...
	public void processInitiator(TaskInfo taskInfo, AssigneeRule assigneeRule, String value)
	{
		String processInstanceId = taskInfo.getProcessInstanceId();
		String startUserId = internalProcessConnector.findInitiator(processInstanceId);
		String userId = assigneeRule.process(startUserId);
	...
	public void processActivityAssignee(TaskInfo taskInfo, AssigneeRule assigneeRule, String value)
	{
		String processInstanceId = taskInfo.getProcessInstanceId();
