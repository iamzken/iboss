...
{
	private static Logger logger = LoggerFactory.getLogger(ActivityAssigneeRule.class);
	...
	public List<String> process(String value, String initiator)
	{
		...
		String userId = ApplicationContextHelper.getBean(InternalProcessConnector.class).findAssigneeByActivityId(processInstanceId, activityId);
