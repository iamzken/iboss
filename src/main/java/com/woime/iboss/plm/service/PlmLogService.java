package com.woime.iboss.plm.service;
...
public class PlmLogService
{
	...
	public void issueAssigned(PlmIssue oldIssue, PlmIssue newIssue, String userId)
	{
		PlmLog plmLog = new PlmLog();
		...
		plmLog.setUserId(userId);
		plmLog.setPlmIssue(newIssue);
		plmLog.setContent(oldIssue.getAssigneeId() + " to " + newIssue.getAssigneeId());
		plmLogManager.save(plmLog);
	}
