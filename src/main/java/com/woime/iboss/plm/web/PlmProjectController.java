...
public class PlmProjectController
{
	...
	public String save(@ModelAttribute PlmProject plmProject, @RequestParam Map<String, Object> parameterMap, RedirectAttributes redirectAttributes)
	{
	...
	{
		List<PlmProject> plmProjects = plmProjectManager.findByIds(selectedItem);
