package com.woime.iboss.form.web;
...
public class FormTemplateController
{
	...
	public String save(@ModelAttribute FormTemplate formTemplate, @RequestParam Map<String, Object> parameterMap, RedirectAttributes redirectAttributes)
	{
		...
		// TODO:中文乱码，tomcat设定无效?
		String content = getEncode(dest.getContent());
		String code = getEncode(dest.getCode());
		String name = getEncode(dest.getName());
