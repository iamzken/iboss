package com.woime.iboss.leave.web;
...
import com.woime.iboss.leave.persistence.manager.LeaveInfoManager;
...
public class LeaveInfoController
{
	...
	public String save(@ModelAttribute LeaveInfo leaveInfo, @RequestParam Map<String, Object> parameterMap, RedirectAttributes redirectAttributes)
	{
		String tenantId = tenantHolder.getTenantId();
		LeaveInfo dest = null;
