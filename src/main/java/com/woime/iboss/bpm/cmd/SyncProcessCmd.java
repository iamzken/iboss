...
import com.woime.iboss.bpm.persistence.manager.BpmConfCountersignManager;
...
import com.woime.iboss.bpm.support.TaskDefinitionBuilder;
...
public class SyncProcessCmd implements Command<Void>
{
	...
	public int processUserTaskConf(BpmConfNode bpmConfNode, String value, int type, int priority)
	{
		...
		BpmConfUser bpmConfUser = bpmConfUserManager.findUnique("from BpmConfUser where value=? and type=? and priority=? and bpmConfNode=?", value, type, priority, bpmConfNode);
