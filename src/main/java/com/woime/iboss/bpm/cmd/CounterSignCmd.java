...
public class CounterSignCmd implements Command<Object>
{
	 ...
	 *            collection 的每个元素变量名
	 */
	public CounterSignCmd(final String operateType, final String activityId, final String assignee, final String processInstanceId, final String collectionVariableName,
