package com.woime.iboss.bpm.util;
...
public class CustomProcessDiagramGenerator
{
	...
	public InputStream generateDiagram(String processInstanceId) throws IOException
	{
		...
		getBpmnModelCmd.execute(Context.getCommandContext());
		...
		List<HistoricActivityInstance> activityInstances = Context.getCommandContext().getHistoricActivityInstanceEntityManager()
