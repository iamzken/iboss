...
import com.woime.iboss.api.template.TemplateConnector;
import com.woime.iboss.api.template.TemplateDTO;
...
import com.woime.iboss.bpm.persistence.manager.BpmConfNoticeManager;
import com.woime.iboss.bpm.persistence.manager.BpmMailTemplateManager;
...
public class BpmConfNoticeController
{
	...
	public String save(@ModelAttribute BpmConfNotice bpmConfNotice, @RequestParam("bpmConfNodeId") Long bpmConfNodeId, @RequestParam("templateCode") String templateCode,
