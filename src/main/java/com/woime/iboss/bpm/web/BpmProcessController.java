...
import com.woime.iboss.bpm.persistence.manager.BpmTaskDefManager;
...
public class BpmProcessController
{
	...
	public String save(@ModelAttribute BpmProcess bpmProcess, @RequestParam("bpmCategoryId") Long bpmCategoryId, @RequestParam("bpmConfBaseId") Long bpmConfBaseId,
			RedirectAttributes redirectAttributes)
	{
		...
		return "redirect:/bpm/bpm-process-list.do#config&workflow";
	}
