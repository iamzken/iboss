...
import com.woime.iboss.bpm.cmd.ChangeSubTaskCmd;
import com.woime.iboss.bpm.cmd.JumpCmd;
import com.woime.iboss.bpm.cmd.ListActivityCmd;
import com.woime.iboss.bpm.cmd.MigrateCmd;
import com.woime.iboss.bpm.cmd.ProcessDefinitionDiagramCmd;
import com.woime.iboss.bpm.cmd.ReOpenProcessCmd;
import com.woime.iboss.bpm.cmd.SyncProcessCmd;
import com.woime.iboss.bpm.cmd.UpdateProcessCmd;
import com.woime.iboss.bpm.persistence.domain.BpmConfBase;
import com.woime.iboss.bpm.persistence.domain.BpmConfCountersign;
...
import com.woime.iboss.bpm.persistence.domain.BpmConfNotice;
import com.woime.iboss.bpm.persistence.domain.BpmConfOperation;
...
import com.woime.iboss.core.util.IoUtils;
...
public class ConsoleController
{
	...
	public String processUpload(@RequestParam("file") MultipartFile file, RedirectAttributes redirectAttributes) throws Exception
	{
		String tenantId = tenantHolder.getTenantId();
		String fileName = file.getOriginalFilename();
		Deployment deployment = processEngine.getRepositoryService().createDeployment().addInputStream(fileName, file.getInputStream()).tenantId(tenantId).deploy();
		List<ProcessDefinition> processDefinitions = processEngine.getRepositoryService().createProcessDefinitionQuery().deploymentId(deployment.getId()).list();
