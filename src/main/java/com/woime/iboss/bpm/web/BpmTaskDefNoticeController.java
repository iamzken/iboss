...
import com.woime.iboss.bpm.persistence.domain.BpmTaskDefNotice;
...
import com.woime.iboss.bpm.persistence.manager.BpmTaskDefNoticeManager;
...
public class BpmTaskDefNoticeController
{
	...
	public String save(@ModelAttribute BpmTaskDefNotice bpmTaskDefNotice, @RequestParam("bpmProcessId") Long bpmProcessId, @RequestParam("bpmMailTemplateId") Long bpmMailTemplateId,
