...
import com.woime.iboss.bpm.persistence.domain.BpmConfAssign;
...
import com.woime.iboss.bpm.persistence.manager.BpmConfAssignManager;
...
public class BpmConfUserController
{
	...
	public String remove(@RequestParam("id") Long id)
	{
		...
		{
			// ���� > Ĭ��
			taskDefinitionConnector.updateTaskUser(taskDefinitionKey, processDefinitionId, taskUser, "active");
		}
		else if (bpmConfUser.getStatus() == 1)
		{
			// ��� > ɾ��
		...
		{
			// Ĭ�� > ����
			taskDefinitionConnector.updateTaskUser(taskDefinitionKey, processDefinitionId, taskUser, "disable");
		}
