...
import com.woime.iboss.bpm.expr.Expr;
import com.woime.iboss.bpm.expr.ExprProcessor;
import com.woime.iboss.bpm.support.DefaultTaskListener;
import com.woime.iboss.spi.process.InternalProcessConnector;
import com.woime.iboss.spi.process.ParticipantDefinition;
...
//	private BeanMapper beanMapper = new BeanMapper();
	...
	public List<String> process(String text)
	{
		String sql = "select child.NAME from PARTY_ENTITY parent,PARTY_STRUCT ps,PARTY_ENTITY child,PARTY_TYPE child_type"
				+ " where parent.ID=ps.PARENT_ENTITY_ID and ps.CHILD_ENTITY_ID=child.ID and child.TYPE_ID=child_type.ID" + " and child_type.PERSON=1 and parent.NAME=?";
