...
@Transactional
@Component("com.woime.iboss.party.subscribe.UserCreatedSubscriber")
public class UserCreatedSubscriber implements Subscribable<String>
{
	...
	public void handleMessage(String message)
	{
		...
		try
		{
			...
			jdbcTemplate.update(insertPartyEntitySql, idGenerator.generateId(), userDto.getUsername(), userDto.getId(), typeId, tenantId);
