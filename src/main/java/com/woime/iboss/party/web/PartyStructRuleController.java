...
import com.woime.iboss.party.persistence.domain.PartyStructRule;
import com.woime.iboss.party.persistence.domain.PartyStructType;
import com.woime.iboss.party.persistence.domain.PartyType;
import com.woime.iboss.party.persistence.manager.PartyStructRuleManager;
...
public class PartyStructRuleController
{
	...
	public String save(@RequestParam(value = "id", required = false) Long id, @RequestParam("partyStructTypeId") Long partyStructTypeId, @RequestParam("parentTypeId") Long parentTypeId,
			@RequestParam("childTypeId") Long childTypeId, RedirectAttributes redirectAttributes)
	{
		String tenantId = tenantHolder.getTenantId();
