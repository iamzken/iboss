package com.woime.iboss.sign.web;
...
import com.woime.iboss.sign.persistence.manager.SignInfoManager;
...
public class SignInfoController
{
	...
	public String save(@ModelAttribute SignInfo signInfo, @RequestParam Map<String, Object> parameterMap, RedirectAttributes redirectAttributes)
	{
		String tenantId = tenantHolder.getTenantId();
		SignInfo dest = null;
