package com.woime.iboss.api.humantask;
...
public interface HumanTaskConnector
{
	 ...
	 * 完成任务.
	 */
	void completeTask(String humanTaskId, String userId, String action, String comment, Map<String, Object> taskParameters);
	 ...
	 * 回退，指定节点，上个执行人.
	 */
	void rollbackActivityLast(String humanTaskId, String activityId, String comment);

	/**
	 * 回退，指定节点，指定执行人.
	 */
	void rollbackActivityAssignee(String humanTaskId, String activityId, String userId, String comment);
	 ...
	 * 回退，上个节点，指定执行人.
	 */
	void rollbackPreviousAssignee(String humanTaskId, String userId, String comment);
	...
	/** 待办任务. */
	Page findPersonalTasks(String userId, String tenantId, int pageNo, int pageSize);

	/** 已办任务. */
	Page findFinishedTasks(String userId, String tenantId, int pageNo, int pageSize);

	/** 待领任务. */
	Page findGroupTasks(String userId, String tenantId, int pageNo, int pageSize);

	/** 经手任务. */
	Page findDelegateTasks(String userId, String tenantId, int pageNo, int pageSize);
}
