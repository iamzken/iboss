...
import com.woime.iboss.auth.component.RoleChecker;
import com.woime.iboss.auth.persistence.domain.Role;
import com.woime.iboss.auth.persistence.domain.RoleDef;
import com.woime.iboss.auth.persistence.manager.RoleDefManager;
...
public class RoleController
{
	...
	public String remove(@RequestParam("selectedItem") List<Long> selectedItem, RedirectAttributes redirectAttributes)
	{
		...
		// return "redirect:/auth/role-list.do";
		return "redirect:/auth/role-viewList.do#config&role";
	}
