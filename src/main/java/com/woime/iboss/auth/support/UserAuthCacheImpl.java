...
public class UserAuthCacheImpl implements UserAuthCache
{
	...
	public void updateUserAuth(UserAuthDTO userAuthDto)
	{
		...
		cache.put("userAuthUsername:" + userAuthDto.getUsername() + ":" + userAuthDto.getTenantId(), userAuthDto);
		cache.put("userAuthRef:" + userAuthDto.getRef() + ":" + userAuthDto.getTenantId(), userAuthDto);
		cache.put("userAuthId:" + userAuthDto.getId() + ":" + userAuthDto.getTenantId(), userAuthDto);
	}
