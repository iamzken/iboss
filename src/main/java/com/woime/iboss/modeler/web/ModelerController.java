package com.woime.iboss.modeler.web;
...
public class ModelerController
{
	...
	public String openModel(@PathVariable("modelId") String modelId) throws Exception
	{
		...
		if (bytes != null)
		{
			...
			Map<String, Object> modelNode = jsonMapper.fromJson(modelEditorSource, Map.class);
	...
	@ResponseBody
	public String modelSave(@PathVariable("modelId") String modelId, @RequestParam("description") String description, @RequestParam("json_xml") String jsonXml, @RequestParam("name") String name,
