...
import com.woime.iboss.core.store.ByteArrayDataSource;
import com.woime.iboss.user.ImageUtils;
import com.woime.iboss.user.avatar.AvatarCache;
...
public class UserAvatarService
{
	...
	public DataSource viewAvatarByUsername(String username, int width, String tenantId) throws Exception
	{
	...
	public DataSource viewAvatarByAccountInfo(AccountInfo accountInfo, int width, String tenantId) throws Exception
	{
		String key = null;
