...
public class AccountDeviceController
{
	...
	public String save(@ModelAttribute AccountDevice accountDevice, @RequestParam(value = "password", required = false) String password,
	...
	{
		String tenantId = tenantHolder.getTenantId();
		List<AccountDevice> accountDevices = accountDeviceManager.findByIds(selectedItem);
