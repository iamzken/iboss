...
public class AccountInfoController
{
	...
	public String list(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, Model model)
	{
		...
		List<AccountInfo> ais = (List<AccountInfo>) page.getResult();
		for(AccountInfo ai : ais) {
			UserStatus us = userStatusManager.findUniqueBy("ref", ai.getId() + "");
			...
			if(us != null) {
				...
				ai.setAuthorities(buff.toString());
			}
			ai.setInfo(personInfoManager.findUniqueBy("id", ai.getId()));
		}
	...
	public String input(@RequestParam(value = "id", required = false) Long id, Model model)
	{
		...
		if (id != null)
		{
            ...
            accountInfo.setInfo(personInfoManager.findUniqueBy("id", id));
		}
		else
		{
	...
	public String save(@ModelAttribute AccountInfo accountInfo, @RequestParam(value = "password", required = false) String password,
			@RequestParam(value = "confirmPassword", required = false) String confirmPassword, RedirectAttributes redirectAttributes) throws Exception
	{
        ...
        dest.setInfo(accountInfo.getInfo());
		...
		return "redirect:/user/account-info-list.do#config&user";
	}
