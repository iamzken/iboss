...
import com.woime.iboss.api.avatar.AvatarConnector;
import com.woime.iboss.api.avatar.AvatarDTO;
...
import com.woime.iboss.core.store.InputStreamDataSource;
import com.woime.iboss.core.store.MultipartFileDataSource;
import com.woime.iboss.core.util.IoUtils;
import com.woime.iboss.user.ImageUtils;
...
import com.woime.iboss.user.service.ChangePasswordService;
import com.woime.iboss.user.support.ChangePasswordResult;
...
public class MyController
{
	...
	public String changePasswordSave(@RequestParam("oldPassword") String oldPassword, @RequestParam("newPassword") String newPassword, @RequestParam("confirmPassword") String confirmPassword,
	...
	public void avatarView(OutputStream os) throws Exception
	{
		...
		StoreDTO storeDto = storeConnector.getStore("avatar", avatarDto.getCode(), tenantId);
	...
	public String myDeviceList(@ModelAttribute Page page, Model model)
	{
		...
		page = accountDeviceManager.pagedQuery(hql, page.getPageNo(), page.getPageSize(), accountId);
