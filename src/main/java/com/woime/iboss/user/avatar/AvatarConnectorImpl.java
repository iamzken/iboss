package com.woime.iboss.user.avatar;
...
{
	private static Logger logger = LoggerFactory.getLogger(AvatarConnectorImpl.class);
	...
	public AvatarDTO findAvatar(String userId)
	{
		try
		{
			...
			AccountAvatar accountAvatar = accountAvatarManager.findUnique(hql, accountId);
	...
	public InputStream findAvatarInputStream(String userId)
	{
		...
		{
			Long accountId = Long.parseLong(userId);
			DataSource dataSource = userAvatarService.viewAvatarById(accountId, 35, "1");
