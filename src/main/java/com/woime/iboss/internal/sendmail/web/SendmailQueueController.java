package com.woime.iboss.internal.sendmail.web;
...
public class SendmailQueueController
{
	...
	public String save(@ModelAttribute SendmailQueue sendmailQueue, @RequestParam("sendmailConfigId") Long sendmailConfigId, @RequestParam("sendmailTemplateId") Long sendmailTemplateId,
