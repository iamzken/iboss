package com.woime.iboss.internal.sendmail.rs;
...
public class SendmailResource
{
	...
	@Path("send")
	@POST
	public BaseDTO send(@FormParam("to") String to, @FormParam("subject") String subject, @FormParam("content") String content, @FormParam("configCode") String configCode,
	...
	@Path("sendTemplate")
	@POST
	public BaseDTO sendTemplate(@FormParam("to") String to, @FormParam("data") String data, @FormParam("templateCode") String templateCode, @FormParam("configCode") String configCode,
			@FormParam("tenantId") String tenantId)
	{
		logger.debug("to : {}", to);
