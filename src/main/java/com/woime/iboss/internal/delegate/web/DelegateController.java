package com.woime.iboss.internal.delegate.web;
...
import com.woime.iboss.internal.delegate.persistence.manager.DelegateHistoryManager;
import com.woime.iboss.internal.delegate.persistence.manager.DelegateInfoManager;
import com.woime.iboss.internal.delegate.service.DelegateService;
...
public class DelegateController
{
	...
	public String autoDelegate(@RequestParam(value = "startTime", required = false) Date startTime, @RequestParam(value = "endTime", required = false) Date endTime,
			@RequestParam("processDefinitionId") String processDefinitionId, @RequestParam("taskDefinitionKey") String taskDefinitionKey, @RequestParam("attorney") String attorney) throws Exception
	{
		String userId = currentUserHolder.getUserId();
		String tenantId = tenantHolder.getTenantId();
