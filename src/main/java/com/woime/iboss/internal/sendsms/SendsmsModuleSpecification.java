package com.woime.iboss.internal.sendsms;
...
@Component
public class SendsmsModuleSpecification implements ModuleSpecification
{
	private static final String MODULE_NAME = "sendsms";
