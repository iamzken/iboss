package com.woime.iboss.operation.service;
...
public class OperationService
{
	...
	{
		String processInstanceId = processConnector.startProcess(userId, businessKey, processDefinitionId, processParameters);
	...
	{
		// try {
		humanTaskConnector.completeTask(humanTaskId, userId, formParameter.getAction(), formParameter.getComment(), taskParameters);
