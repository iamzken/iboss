...
import com.woime.iboss.api.keyvalue.FormParameter;
...
import com.woime.iboss.button.ButtonDTO;
import com.woime.iboss.button.ButtonHelper;
...
import com.woime.iboss.operation.service.OperationService;
...
public class TaskOperationController
{
	...
	public String completeTask(HttpServletRequest request, RedirectAttributes redirectAttributes) throws Exception
	{
		...
		try
		{
			...
			logger.debug("getMultiValueMap : {}", multipartHandler.getMultiValueMap());
			logger.debug("getMultiFileMap : {}", multipartHandler.getMultiFileMap());
		...
		try
		{
			...
			this.operationService.completeTask(humanTaskId, userId, formParameter, taskParameters, record, humanTaskDto.getProcessInstanceId());
		}
	...
	public String rollbackInitiator(@RequestParam("humanTaskId") String humanTaskId, @RequestParam("_humantask_comment_") String comment)
	{
	...
	public String withdraw(@RequestParam("humanTaskId") String humanTaskId, @RequestParam("comment") String comment)
	{
	...
	public String transfer(@RequestParam("humanTaskId") String humanTaskId, @RequestParam("userId") String userId, @RequestParam("comment") String comment)
	{
	...
	public String cancel(@RequestParam("humanTaskId") String humanTaskId, @RequestParam("userId") String userId, @RequestParam("comment") String comment)
	{
	...
	public String delegateTask(@RequestParam("humanTaskId") String humanTaskId, @RequestParam("userId") String userId, @RequestParam("comment") String comment)
	{
	...
	public String delegateTaskCreate(@RequestParam("humanTaskId") String humanTaskId, @RequestParam("userId") String userId, @RequestParam("comment") String comment)
	{
	...
	public String communicate(@RequestParam("humanTaskId") String humanTaskId, @RequestParam("userId") String userId, @RequestParam("comment") String comment)
	{
		logger.info("communicate : humanTaskId : {}, userId : {}, comment : {}", humanTaskId, userId, comment);
	...
	public String callback(@RequestParam("humanTaskId") String humanTaskId, @RequestParam("comment") String comment)
	{
	...
	public String createVote(@RequestParam("humanTaskId") String humanTaskId, @RequestParam("userIds") String userIds, @RequestParam("comment") String comment)
	{
		...
		for (String userId : userIds.split(","))
		{
			...
			childTask.setPresentationSubject(parentTask.getPresentationSubject());
	...
	public FormParameter buildFormParameter(MultipartHandler multipartHandler)
	{
		...
		formParameter.setComment(multipartHandler.getMultiValueMap().getFirst("_humantask_comment_"));
		formParameter.setAction(multipartHandler.getMultiValueMap().getFirst("_humantask_action_"));
