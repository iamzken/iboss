package com.woime.iboss.pim.web;
...
import com.woime.iboss.pim.persistence.domain.PimPhrase;
...
public class PimPhraseController
{
	...
	public String myInput(@RequestParam(value = "id", required = false) Long id, Model model)
	{
		if (id != null)
		{
	...
	public String mySave(@ModelAttribute PimPhrase pimPhrase, RedirectAttributes redirectAttributes)
	{
		String userId = currentUserHolder.getUserId();
	...
	public String myRemove(@RequestParam("selectedItem") List<Long> selectedItem, RedirectAttributes redirectAttributes)
	{
	...
	public String save(@ModelAttribute PimPhrase pimPhrase, RedirectAttributes redirectAttributes)
	{
		String userId = currentUserHolder.getUserId();
		String tenantId = tenantHolder.getTenantId();
		Long id = pimPhrase.getId();
