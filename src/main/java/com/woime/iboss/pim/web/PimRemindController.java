...
import com.woime.iboss.pim.persistence.domain.PimRemind;
import com.woime.iboss.pim.persistence.manager.PimRemindManager;
...
public class PimRemindController
{
	...
	public String save(@ModelAttribute PimRemind pimRemind, RedirectAttributes redirectAttributes)
	{
		String userId = currentUserHolder.getUserId();
