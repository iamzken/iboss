...
import com.woime.iboss.party.persistence.domain.PartyStruct;
...
import com.woime.iboss.party.persistence.manager.PartyStructManager;
import com.woime.iboss.party.persistence.manager.PartyStructTypeManager;
import com.woime.iboss.party.persistence.manager.PartyTypeManager;
import com.woime.iboss.party.service.PartyService;

@Controller("com.woime.iboss.org.web.OrgController")
@RequestMapping("org")
public class OrgController
{
	...
	public String users(Model model, @RequestParam(value = "partyStructTypeId", required = false) Long partyStructTypeId, @RequestParam(value = "partyEntityId", required = false) Long partyEntityId,
	...
	public String inputUser(Model model, @RequestParam(value = "partyStructTypeId", required = false) Long partyStructTypeId,
	...
	public String saveUser(@ModelAttribute PartyStruct partyStruct, @RequestParam("name") String name, @RequestParam("partyEntityId") Long partyEntityId,
			@RequestParam("partyStructTypeId") Long partyStructTypeId) throws Exception
	{
		String tenantId = tenantHolder.getTenantId();
	...
	public String children(Model model, @RequestParam(value = "partyStructTypeId", required = false) Long partyStructTypeId,
			@RequestParam(value = "partyEntityId", required = false) Long partyEntityId, @ModelAttribute Page page) throws Exception
	{
		String tenantId = tenantHolder.getTenantId();
		init(model, partyStructTypeId, partyEntityId);
	...
	public String inputChild(Model model, @RequestParam(value = "partyStructTypeId", required = false) Long partyStructTypeId,
			@RequestParam(value = "partyEntityId", required = false) Long partyEntityId) throws Exception
	{
		String tenantId = tenantHolder.getTenantId();
		init(model, partyStructTypeId, partyEntityId);
	...
	public String saveChild(@RequestParam("name") String name, @RequestParam("partyTypeId") Long partyTypeId, @RequestParam("partyEntityId") Long partyEntityId,
