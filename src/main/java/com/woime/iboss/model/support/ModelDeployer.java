package com.woime.iboss.model.support;
...
import com.woime.iboss.model.persistence.manager.ModelFieldManager;
import com.woime.iboss.model.persistence.manager.ModelInfoManager;
...
public class ModelDeployer
{
	...
	public void processBusiness(ProcessDefinition processDefinition)
	{
		...
		for (HumanTaskDefinition humanTaskDefinition : humanTaskDefinitions)
		{
			try
			{
				com.woime.iboss.spi.humantask.FormDTO formDto = taskDefinitionConnector.findForm(humanTaskDefinition.getKey(), processDefinitionId);
