package com.woime.iboss.model.web;
...
public class ModelController
{
	...
	public void export(@RequestParam("id") Long id, @ModelAttribute Page page, @RequestParam(value = "q", required = false) String q, HttpServletRequest request, HttpServletResponse response)
			throws Exception
	{
		ModelInfo modelInfo = modelInfoManager.get(id);
