package com.woime.iboss.javamail.web;
...
import com.woime.iboss.javamail.service.JavamailQueue;
import com.woime.iboss.javamail.service.JavamailService;
...
public class JavamailController
{
	...
	public String index(@RequestParam(value = "id", required = false) Long id, @RequestParam(value = "folder", required = false) String folder, Model model) throws Exception
	{
		...
		if (javamailConfig != null)
		{
			...
			List<JavamailMessage> javamailMessages = javamailMessageManager.find(hql, javamailConfig.getId(), folder);
	...
	@RequestMapping("send")
	public String send(@RequestParam("receiver") String receiver, @RequestParam(value = "cc", required = false) String cc, @RequestParam(value = "bcc", required = false) String bcc,
