...
import com.woime.iboss.javamail.support.JavamailCmd;
...
//	private boolean active = true;
	...
	public void doProcessSend() throws Exception
	{
		...
		try
		{
			...
			{
				javamailService.send(javamailCmd.getFrom(), javamailCmd.getTo(), javamailCmd.getCc(), javamailCmd.getBcc(), javamailCmd.getSubject(), javamailCmd.getContent());
			}
			else
			{
				logger.info("unsupport : {}", javamailCmd.getType());
