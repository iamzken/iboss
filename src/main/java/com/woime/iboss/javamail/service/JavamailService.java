package com.woime.iboss.javamail.service;
...
import com.woime.iboss.javamail.persistence.manager.JavamailConfigManager;
import com.woime.iboss.javamail.persistence.manager.JavamailMessageManager;
import com.woime.iboss.javamail.support.SmtpAuthenticator;
...
public class JavamailService
{
	...
	public void send(String from, String to, String cc, String bcc, String subject, String content) throws MessagingException
	{
	...
	public void receivePop3(JavamailConfig javamailConfig) throws MessagingException, IOException
	{
		...
		for (Folder folder : store.getUserNamespaces(javamailConfig.getUsername()))
		{
	...
	public void receiveByFolder(Folder folder, JavamailConfig javamailConfig) throws MessagingException, IOException
	{
	...
	public void receiveMessageByFolder(Folder folder, JavamailConfig javamailConfig)
	{
		try
		{
			/*
			...
			for (Message message : messages)
			{
				...
				String from = getFrom(mimeMessage);
				...
				{
					logger.info("{} length {} larger than 255", subject, subject.length());
