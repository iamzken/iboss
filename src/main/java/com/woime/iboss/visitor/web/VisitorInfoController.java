package com.woime.iboss.visitor.web;
...
import com.woime.iboss.visitor.persistence.manager.VisitorInfoManager;
...
public class VisitorInfoController
{
	...
	public String save(@ModelAttribute VisitorInfo visitorInfo, @RequestParam Map<String, Object> parameterMap, RedirectAttributes redirectAttributes)
	{
		String tenantId = tenantHolder.getTenantId();
	...
	{
		List<VisitorInfo> visitorInfos = visitorInfoManager.findByIds(selectedItem);
