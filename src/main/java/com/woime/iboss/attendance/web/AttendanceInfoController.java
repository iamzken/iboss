package com.woime.iboss.attendance.web;
...
import com.woime.iboss.attendance.persistence.manager.AttendanceInfoManager;
...
//	private UserConnector userConnector;
	...
	public String save(@ModelAttribute AttendanceInfo attendanceInfo, @RequestParam Map<String, Object> parameterMap, RedirectAttributes redirectAttributes)
	{
		String tenantId = tenantHolder.getTenantId();
	...
	{
		List<AttendanceInfo> attendanceInfos = attendanceInfoManager.findByIds(selectedItem);
	...
	public void export(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		List<AttendanceInfo> attendanceInfos = (List<AttendanceInfo>) page.getResult();
	...
	// ~ ======================================================================
	@Resource
	public void setAttendanceInfoManager(AttendanceInfoManager attendanceInfoManager)
	{
