package com.woime.iboss.contract.web;
...
import com.woime.iboss.contract.persistence.manager.ContractInfoManager;
...
public class ContractInfoController
{
	...
	public String save(@ModelAttribute ContractInfo contractInfo, @RequestParam Map<String, Object> parameterMap, RedirectAttributes redirectAttributes)
	{
		String tenantId = tenantHolder.getTenantId();
	...
	{
		List<ContractInfo> contractInfos = contractInfoManager.findByIds(selectedItem);
	...
	public void export(@ModelAttribute Page page, @RequestParam Map<String, Object> parameterMap, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		List<ContractInfo> contractInfos = (List<ContractInfo>) page.getResult();
