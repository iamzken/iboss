 ...
 * the
 * principal name. The principal name is defined by the {@link Session}
 * attribute with the
...
public interface FindByIndexNameSessionRepository<S extends Session> extends SessionRepository<S>
{
	 ...
	 *
	 * <p>
	 * It is the responsibility of the developer to ensure the attribute is
	 * populated
	 * since Spring Session is not aware of the authentication mechanism being
	 * used.
	 * </p>
	 *
	 * @since 1.1
	 ...
	 *         all sessions
	 *         that contain the session specified index name and the value of
	 *         the specified index
