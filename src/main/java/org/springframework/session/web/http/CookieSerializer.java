...
public interface CookieSerializer
{
	 ...
	 * result is a
	 * List since there can be multiple {@link Cookie} in a single request with
	 * a matching
	 * name. For example, one Cookie may have a path of / and another of
	 * /context, but the
	...
	class CookieValue
	{
		 ...
		 *            the actual cookie so
		 *            long as the original value is returned when the cookie is
		 *            read.
		 */
