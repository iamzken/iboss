...
public class DefaultCookieSerializer implements CookieSerializer
{
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.springframework.session.web.http.CookieSerializer#readCookieValues(
	 * javax.
	 ...
	 * be used
	 * when the request comes from www.example.com. This allows for sharing the
	 * cookie
	 ...
	 * single
	 * grouping that defines what the value is that should be matched. User's
	 * should be
	 * careful not to output malicious characters like new lines to prevent from
	 * things
	 * like
	 ...
	 *            the case insensitive pattern to extract the domain name
	 *            with
	 * @throws IllegalStateException
	 ...
	 * However, this
	 * can help with tracing logs of a particular user. This will ensure that
	 * the value of
