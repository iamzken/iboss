...
abstract class OnCommittedResponseWrapper extends HttpServletResponseWrapper
{
	 ...
	 * invoked before
	 * calling the prior to methods that commit the response. We delegate all
	 * methods to
	 * the original {@link java.io.PrintWriter} to ensure that the behavior is
	 * as close to
	 ...
	 * Ensures{@link OnCommittedResponseWrapper#onResponseCommitted()} is
	 * invoked before
	 * calling methods that commit the response. We delegate all methods to the
	 * original
	 * {@link javax.servlet.ServletOutputStream} to ensure that the behavior is
	 * as close
	 * to the original {@link javax.servlet.ServletOutputStream} as possible.
	 * See SEC-2039
	 *
	 * @author Rob Winch
	 */
