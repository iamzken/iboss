 ...
 * <li>lastAccessedTime - the moment the {@link MapSession} was
 * instantiated</li>
...
public final class MapSession implements ExpiringSession, Serializable
{
	 ...
	 * default
	 * constructor when the id is known to prevent unnecessary consumption on
	 * entropy
	 * which can be slow.
	 *
	 * @param id
	 ...
	 * midnight
	 * of 1/1/1970 GMT. The default is when the {@link Session} was
	 * instantiated.
	 * 
	 * @param creationTime
	 ...
	 * random
	 * generated value to prevent malicious users from guessing this value. The
	 * default is
