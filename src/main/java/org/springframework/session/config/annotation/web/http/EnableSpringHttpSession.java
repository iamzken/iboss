 ...
 * backed by a
 * user provided implementation of {@link SessionRepository}. In order to
 * leverage the
 * annotation, a single {@link SessionRepository} bean must be provided. For
 * example:
 *
 * <pre>
 * <code>
 ...
 * configured
 * for you out of the box. This is because things like session expiration are
 * highly
 * implementation dependent. This means if you require cleaning up expired
 * sessions, you
 ...
 * Spring
 * Session events into HttpSessionEvent. In order for it to work, the
 * implementation of
