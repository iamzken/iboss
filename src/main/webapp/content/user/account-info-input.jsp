...
$(function() {
    $("#userBaseForm").validate({
        ...
        rules: {
            username: {
                remote: {
                    url: 'user/account-info-checkUsername.do',
                    data: {
...
<form id="userBaseForm" method="post" action="${ctx}/user/account-info-save.do" class="form-horizontal">
  ...
  <div class="form-group">
    <label class="control-label col-md-1" for="userBase_username"><spring:message code="user.user.input.username" text="用户ID"/></label>
	<div class="col-sm-5">
  ...
  <div class="form-group">
    <label class="control-label col-md-1" for="userBase_displayName">用户姓名</label>
	<div class="col-sm-5">
  ...
  --%>
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <select name="info.gender" id="userBase_gender" class="form-control required">
                <option value="男" <c:if test="${model.info.gender eq '男'}">selected</c:if>>男</option>
                <option value="女" <c:if test="${model.info.gender eq '女'}">selected</c:if>>女</option>
            </select>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input id="userBase_im" type="text" name="info.im" value="${model.info.im}" size="40" class="form-control required" minlength="2" maxlength="50">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-md-1" for="userBase_telephone">部门电话</label>
        <div class="col-sm-5">
            <input id="userBase_telephone" type="text" name="info.telephone" value="${model.info.telephone}" size="40" class="form-control required" minlength="2" maxlength="50">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-md-1" for="userBase_cellphone">移动电话</label>
        <div class="col-sm-5">
            <input id="userBase_cellphone" type="text" name="info.cellphone" value="${model.info.cellphone}" size="40" class="form-control required" minlength="2" maxlength="50">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input id="userBase_email" type="text" name="info.email" value="${model.info.email}" size="40" class="form-control required" minlength="2" maxlength="50">
        </div>
    </div>
