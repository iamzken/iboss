...
var config = {
	...
	exportUrl: 'bpm/bpm-conf-user-export.do'
};
*/
var config = {};
var table;
  ...
  <body>
    ...
    <div class="row-fluid">
	  ...
	  <ul class="breadcrumb">
	    ...
	    <li><a href="bpm/bpm-conf-node-list.do?bpmConfBaseId=${bpmConfBaseId}">${bpmConfBase.processDefinitionKey}</a></li>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		  ...
		  <form name="bpmCategoryForm" method="post" action="bpm/bpm-conf-user-save.do" class="form-inline">
...
<form id="bpm-conf-userGridForm" name="bpm-conf-userGridForm" method='post' action="bpm/bpm-conf-user-remove.do" class="m-form-blank">
      <div class="panel panel-default">
        <div class="panel-heading">
		  <i class="glyphicon glyphicon-list"></i>
    ...
    <table id="bpmCategoryGrid" class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
		    <a href="bpm/bpm-conf-user-remove.do?id=${item.id}">删除</a>
          </td>
        </tr>
        </c:forEach>
      </tbody>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		  ...
		  <form name="bpmConfAssignForm" method="post" action="bpm/bpm-conf-assign-save.do" class="form-inline">
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		  ...
		  <form name="bpmConfCountersignForm" method="post" action="bpm/bpm-conf-countersign-save.do" class="form-inline">
