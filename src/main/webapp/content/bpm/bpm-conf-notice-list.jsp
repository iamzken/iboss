...
var config = {
	...
	exportUrl: 'bpm/bpm-conf-notice-export.do'
};
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
			...
			<a class="btn btn-default" href="bpm/bpm-conf-node-list.do?bpmConfBaseId=${bpmConfBaseId}">返回</a>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		  ...
		  <form name="bpmCategoryForm" method="get" action="bpm/bpm-conf-notice-input.do" class="form-inline">
...
<%--
      <div style="margin-bottom: 20px;">
	    <div class="pull-left btn-group" role="group">
		  <button class="btn btn-default a-insert" onclick="location.href='bpm/bpm-conf-notice-input.do'">新建</button>
...
--%>
<form id="bpm-conf-noticeGridForm" name="bpm-conf-noticeGridForm" method='post' action="bpm/bpm-conf-notice-remove.do" class="m-form-blank">
      <div class="panel panel-default">
        <div class="panel-heading">
		  <i class="glyphicon glyphicon-list"></i>
    ...
    <table id="bpmCategoryGrid" class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
		  ...
		  <td><a class="btn btn-small" href="bpm/bpm-conf-notice-remove.do?id=${item.id}">删除</a></td>
        </tr>
        </c:forEach>
      </tbody>
    </table>
