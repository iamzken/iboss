...
var config = {
	...
	exportUrl: 'bpm/bpm-mail-template-export.do'
};
...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="bpmMailTemplateSearch" class="content content-inner">
		  ...
		  <form name="bpmMailTemplateForm" method="post" action="bpm/bpm-mail-template-list.do" class="form-inline">
	  ...
	  <article style="margin-bottom:10px;">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='bpm/bpm-mail-template-input.do'"><spring:message code="core.list.create" text="新建"/></button>
  ...
  <form id="bpmMailTemplateGridForm" name="bpmMailTemplateGridForm" method='post' action="bpm/bpm-mail-template-remove.do" style="margin:0px;">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="bpm/bpm-mail-template-input.do?id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>&nbsp;
			</region:region-permission>
          </td>
        </tr>
        </c:forEach>
