...
var config = {
	...
	exportUrl: 'bpm/bpm-conf-rule-export.do'
};
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		  ...
		  <form name="bpmCategoryForm" method="post" action="bpm/bpm-conf-rule-save.do" class="form-inline">
...
<%--
      <div style="margin-bottom: 20px;">
	    <div class="pull-left btn-group" role="group">
		  <button class="btn btn-default a-insert" onclick="location.href='bpm/bpm-conf-rule-input.do'">新建</button>
...
<form id="bpm-conf-ruleGridForm" name="bpm-conf-ruleGridForm" method='post' action="bpm/bpm-conf-rule-remove.do" class="m-form-blank">
      <div class="panel panel-default">
        <div class="panel-heading">
		  <i class="glyphicon glyphicon-list"></i>
    ...
    <table id="bpmCategoryGrid" class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>${item.value}</td>
          <td>
		    <a href="bpm/bpm-conf-rule-remove.do?id=${item.id}">删除</a>
          </td>
        </tr>
        </c:forEach>
      </tbody>
