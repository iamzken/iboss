...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		  ...
		  <form name="bpmCategoryForm" method="post" action="bpm/bpm-conf-listener-save.do" class="form-inline">
    ...
    <table id="bpmCategoryGrid" class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
		    <a href="bpm/bpm-conf-listener-remove.do?id=${item.id}&bpmConfNodeId=${param.bpmConfNodeId}">删除</a>
          </td>
        </tr>
        </c:forEach>
      </tbody>
