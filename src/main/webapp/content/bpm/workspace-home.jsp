        ...
        <div class="col-md-2">
		  <div class="caption">
            ...
            <div class="btn-group" style="margin-bottom:10px;">
              ...
              <a class="btn btn-default btn-sm" href="bpm/workspace-graphProcessDefinition.do?bpmProcessId=${bpmProcess.id}" target="_blank"><i class="glyphicon glyphicon-picture"></i> 图形</a>
            </div>
		  </div>
        </div>
